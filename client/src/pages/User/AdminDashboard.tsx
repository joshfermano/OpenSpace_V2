            ...
            <div className="flex-shrink-0">
              <div className="flex gap-2">
                ...
                <Link
                  ...
                  className="inline-flex items-center justify-center w-full sm:w-auto px-4 py-2 text-sm font-medium text-white bg-orange-600 rounded-lg hover:bg-orange-700 transition-colors shadow-sm">
                  Platform Fees
                </Link>
              </div>
            </div>
